...
public class RearCameraTestActivity extends AppCompatActivity {
    ...
    private static final String TAG = "RearCameraTestActivity";
    ...
    private void startCamera() {
        ...
        try {
            String cameraId = manager.getCameraIdList()[0]; // Rear camera is usually at index 0
        ...
        try {
            ...
            cameraDevice.createCaptureSession(Arrays.asList(surface), new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigureFailed(@NonNull CameraCaptureSession session) {
                    ...
                    Toast.makeText(RearCameraTestActivity.this, "Failed to configure camera", Toast.LENGTH_SHORT).show();
                }
            }, null);
        } catch (CameraAccessException e) {
            e.printStackTrace();
